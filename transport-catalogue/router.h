...
template <typename Weight>
Router<Weight>::Router(const Graph& graph, const std::optional<RoutesInternalData>& routes_internal_data) : graph_(graph), routes_internal_data_(routes_internal_data)
{
}
